...
public class SpinningRecord extends PApplet {
    ...
    Song song = new Song("_01_methods/_2_spinning_record/Crawling Song.mp3");
    @Override
    public void settings() {
        size(WIDTH, HEIGHT);
        background(227, 34, 192);
    }

    @Override
    public void setup() {
        size(600, 600);
        pictureOfRecord = loadImage("src/_01_methods/_2_spinning_record/record.png");
